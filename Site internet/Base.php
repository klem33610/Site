    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item form-inline">
          ...
          <a class="nav-link" href="Adhésion.php"><span <i class="fas fa-file-contract"></i></span> Nous rejoindre<span class="sr-only"></span></a>
          <a class="nav-link" href="#"><span <i class="fas fa-rss-square"></i></span> Nouveautés<span class="sr-only"></span></a>
          <a class="nav-link" href="Intranet_Suivi.php"><span <i class="fas fa-toolbox"></i></span> Intranet <span class="sr-only"</span></a>
        </li>
      </ul>
