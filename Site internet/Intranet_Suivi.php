...
<body>
  <form class="text-center d-none" action="/static/upload.php" method="post" enctype="multipart/form-data">
  ...
  <div class="form-group col-sm-12 mx-auto">
    <div class="shadow card bg-light">
      <div class="mb-2 text-center card-header rounded-bottom bg-warning text-white shadow-sm">
          ...
          <div class="timeline__wrap">
            <div class="timeline__items">
              ...
              <? for ($i = 0; $i <= 12; $i++) {
                ...
                <div class="timeline__item" data-toggle="tooltip" data-placement="top" title="<? print_r($print); ?>">
                  <div class="<? if ($i == 0) {
                                echo "border border-warning rounded ";
                              } ?> text-center timeline__content">
                    <h2><? echo strftime("%B %Y", strtotime($Month->format("F - Y"))); ?><br></h2>
                    <p>Somme des promesses de dons :</p>
                    <p> <? echo  $Sum_Dons . " "; ?> euros </p>
                  </div>
        ...
        <div id="membercard" data-parent="#myGroup" class="collapse show">
              ...
              <tbody>
                <? foreach ($tableau as $i => $value) {
                  ...
                  if ($Inscription->format('Y') == $Year_Don - 1) {
                    ?>
                    <tr>
                      <td><input id="<? echo $tableau[$i]['id']; ?>" style="width:23px; height:23px" class="form-check-input mx-auto card" type="checkbox"></td>
                      <td><input id="<? echo $tableau[$i]['id']; ?>" style="width:23px; height:23px" class="form-check-input mx-auto fiscal" type="checkbox"></td>
                      <td id="prenom"><? echo $tableau[$i]['Prenom']; ?></td>
                      <td id="nom"><? echo $tableau[$i]['Nom']; ?></td>
                      <td id="date"><? echo $Inscription->format('d-m-Y'); ?></td>
                    </tr>
                  <? };
                }; ?>
              </tbody>
          ...
          <div class="card-footer">
            <div class="mx-auto text-center">
              <button type="button" onclick="membreDocs()" class=" btn btn-lg btn-outline-success">Envoyer par mail</button>
            </div>
          </div>
        </div>
              ...
              <tbody>
                <? foreach ($tableau as $i => $value) {
                  ...
                  if ($Inscription->format('Y') == $Year_Don - 1) {
                    ?>
                    <tr>
                      <td><input id="inscription" style="width:23px; height:23px" class="form-check-input mx-auto" type="checkbox"></td>
                      <td><? echo $tableau[$i]['Prenom']; ?></td>
                      <td><? echo $tableau[$i]['Nom']; ?></td>
                      <td><? echo $Inscription->format('d-m-Y'); ?></td>
                    </tr>
            ...
            <tr>
              ...
              foreach ($tableau as $i => $value) {
                ...
                foreach ($tableau[$i] as $key => $val) {
                  $y = $y + 1; ?>
                  <td class="<?php if ($x > 4 or $y > 7) {
                                echo 'other_text ';
                              } ?><? echo $key; ?>"><? echo $tableau[$i][$key]; ?></td>
                <? } ?>
              </tr>
            <? } ?>
          </tbody>
